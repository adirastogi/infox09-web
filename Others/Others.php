...
$query_EventDay1 = "SELECT * FROM event WHERE eventday = 1 AND eventtype = 'Others'";
...
mysql_select_db($database_infox_db, $infox_db);
$query_EventDay2 = "SELECT * FROM event WHERE eventday = 2 AND eventtype = 'Others'";
...
mysql_select_db($database_infox_db, $infox_db);
$query_EventDay3 = "SELECT * FROM event WHERE eventday = 3 AND eventtype = 'Others'";
